document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "VITA"; // Replace with dynamic value
    ...
    yesButton.addEventListener("click", function () {
        questionText.innerHTML = `<span class="partner-name">${partnerName}</span><br><span class="love-text">See you soon love ❤️</span>`;
